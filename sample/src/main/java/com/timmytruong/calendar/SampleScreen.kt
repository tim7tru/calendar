...
import com.timmytruong.calendar.screen.StaticCalendarScreen
...
private fun SingleSelectionCalendar() {
    ...
    Column {
        Calendar(
            ...
            dateSelection = DateSelection.SingleDay(initial = LocalDate.now(),
...
private fun MultiSelectionCalendar() {
    ...
    Column {
        Calendar(
            yearMonth = YearMonth.now(),
            dateSelection = DateSelection.MultipleDay(initial = selectedDates,
                onDaySelected = { it.showToast(context) },
                onStateUpdated = {
                    selectedDates.clear()
...
private fun RangeSelectionCalendar() {
    ...
    Column {
        Calendar(
            yearMonth = YearMonth.now(),
            dateSelection = DateSelection.Range(initial = selectedDates,
                onDaySelected = { it.showToast(context) },
                onStateUpdated = {
                    selectedDates = it
                }),
...
private fun OffDayStaticCalendar() {
    Calendar(
        yearMonth = YearMonth.now(), onMonthDayData = CalendarTextData(
            fontSize = 24.sp,
            textAlign = TextAlign.Center,
